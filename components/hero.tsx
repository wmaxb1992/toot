  ...
  return (
    <section className="relative h-screen flex items-center">
      ...
      <div className="container-custom relative z-20 text-white">
        <div className="max-w-2xl ml-auto mt-32 pr-4" style={{ fontFamily: 'var(--font-montserrat), system-ui, sans-serif' }}>
          <h1 className="text-4xl md:text-6xl font-light mb-6 tracking-wide text-right">
            Move with intention
          </h1>
          <p className="text-base md:text-lg mb-8 font-light opacity-90 max-w-lg overflow-hidden text-right">
